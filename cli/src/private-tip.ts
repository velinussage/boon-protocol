...
async function privateTip(rawHandle: string, options: PrivateTipOptions): Promise<void> {
  ...
  const preview = {
    ...
    calls: [
      walletMode === "local"
        ? "LOCAL.signTypedData(Boon Private Tip Blob) — CLI does not sign for humans; complete this tip in the Boon web app at https://boonprotocol.com/send or in your OWS wallet tooling (see BLOCKERS.md B1)"
