...
Boon docs are built as a static Astro Starlight site. This repository contains the source that contributors can edit, build, and validate locally. The live `docs.boonprotocol.com` deployment is managed by the maintainers after changes are reviewed.
