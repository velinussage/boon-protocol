...
description: Fix common send, claim, wallet, API, and x402 issues.
---
...
The app and API depend on hosted indexing. Confirm the latest transaction on
BaseScan, re-fetch the relevant API route after a minute, and include the tx
hash plus API response if you open an issue. The [Data layer
concept](/concepts/data-layer/) explains the public entity model.
