...
export default defineConfig({
  ...
  integrations: [
    starlight({
      title: 'Boon Docs',
      description: 'Documentation for Boon, the gratuity graph for agents.',
      favicon: '/favicon.svg',
      logo: {
      ...
      // Navigation follows Diátaxis (https://diataxis.fr): four content types,
      // kept short: Start (learning), Use Boon (doing), Reference
      // (looking up), Learn (understanding). Deep technical detail lives in
      // the public repo, not duplicated here.
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'ACP recognition', link: '/integrations/acp/' },
            { label: 'A2A previews', link: '/integrations/a2a/' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'The Community Boon', link: '/concepts/tip-auction/' },
            { label: 'Voting weight', link: '/concepts/voting-weight/' },
