...
export interface ClaimCompleteResponse {
   ...
   * for the newly-linked handle. Populated after a successful v2 link in
   * /claim/complete; absent (or 0) when no intents are queued. Execution
   * itself is a follow-up task; this is a preview only.
   */
