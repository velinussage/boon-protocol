 ...
 *
 * The Solidity hash-equality check mirrors these rules via the
 * `keccak256(displayHandle) == handleHash` assertion in the settlement contract.
 *
...
export interface CanonicalHandle {
  ...
  /** keccak256(utf8(handle)). The contract's escrow key. */
